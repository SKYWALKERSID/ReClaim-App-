...
import { PurgingService } from "./application/purgingService.js";
...
export function buildApp() {
    ...
    const swaggerOptions = {
        definition: {
            openapi: "3.0.0",
            info: {
                title: "Digital Minimalism API",
                version: "1.0.0",
                description: "Production-hardened API for monitoring and enforcing digital minimalism.",
            },
