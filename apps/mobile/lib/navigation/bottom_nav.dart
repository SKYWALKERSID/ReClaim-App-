...
import '../features/app_usage/app_selection_screen.dart';
...
import '../features/insights/brain_mirror_dashboard.dart';
...
class BottomNavState extends State<BottomNav> {
  ...
  Future<void> _runSequentialOnboarding() async {
    ...
    // Step 3: App Selections (Whitelist/Blacklist)
    ...
    return showDialog(
      ...
      builder: (context) => BackdropFilter(
        ...
        child: AlertDialog(
          ...
          title: const Text("Step 3: Configure Protection", 
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => BackdropFilter(
          ...
          child: AlertDialog(
            ...
            title: const Text("Step 2: Set Daily Goal", 
              style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            content: Column(
