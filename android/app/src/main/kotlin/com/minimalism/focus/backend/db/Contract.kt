...
object Contract {
    ...
    // Enforcement Policy Table (Legacy but kept for compatibility)
    object EnforcementPolicy : BaseColumns {
        const val TABLE_NAME = "EnforcementPolicy"
        const val COLUMN_PACKAGE_NAME = "package_name"
        const val COLUMN_DAILY_LIMIT_MS = "daily_limit_ms"
        const val COLUMN_MODE = "mode"
        const val COLUMN_FOCUS_MODE_ALLOWED = "focus_mode_allowed"
    }
}
