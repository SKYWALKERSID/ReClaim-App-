...
class _AppSelectionScreenState extends State<AppSelectionScreen> {
  ...
  Future<void> _loadData() async {
    ...
    // Simple check: if we can fetch usage, accessibility is usually semi-functional or we can prompt
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "For these restrictions to be forced, you must enable the 'Digital Minimalism' service in Android Accessibility settings.",
            style: TextStyle(color: Colors.white70, fontSize: 12),
          ),
          TextButton(
            onPressed: () => _backend.openSettings(),
            child: const Text("Open Settings", style: TextStyle(color: AppColors.warning, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
